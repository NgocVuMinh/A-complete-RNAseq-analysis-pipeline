...
# ________ The following heatmap is for visualizing selected genes

# ________ Example of selected genes: breast cancer prognosis reporters (taken from Supp table 2 DOI:10.1038/415530a )
...
h1 <- Heatmap(mat.scaled[gene_fam,], 
              ...
              cluster_rows = F,
              cluster_columns = T, 
              column_labels = colnames(mat.scaled[gene_fam,]), 
              name="Z-score",
              show_row_names = F,
              show_column_names = F,
